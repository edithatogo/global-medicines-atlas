"""Emit the bronze three-strata qualification report from repository evidence."""
...
def main(argv: list[str] | None = None) -> int:
    """Write and validate the bronze three-strata qualification report."""
    ...
    print(
        ...
        f"three_strata_qualified={report['three_strata_qualified']} "
        f"bronze_mature={report['bronze_mature']} "
