...
- [x] Task: Record Python 3.14 as authoritative and Mojo as experimental: the pinned hosted smoke canary proves toolchain availability, while the machine-validated receipt denies promotion because no real kernel, Arrow parity, runtime fallback path or representative benchmark exists ([#39](https://github.com/edithatogo/global-medicines-atlas/issues/39))
