...
LEGACY_MANIFEST_PARSER_IDENTITY = "gma.acquisition-receipt.v2"
LEGACY_MANIFEST_TRANSFORMATION_IDENTITY = "gma.bronze.acquisition-manifest.v1"
LEGACY_MANIFEST_SCHEMA_VERSION = "bronze-acquisition-manifest-v1"
MANIFEST_PARSER_IDENTITY = "gma.b1-native-evidence.v1"
MANIFEST_TRANSFORMATION_IDENTITY = "gma.bronze.acquisition-manifest.v2"
MANIFEST_SCHEMA_VERSION = "bronze-acquisition-manifest-v2"
