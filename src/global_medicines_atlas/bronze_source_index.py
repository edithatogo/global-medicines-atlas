...
def render_b0_source_index_markdown(index: B0SourceIndex) -> str:
    ...
    lines = [
        ...
        "verified; metadata verified is not payload acquired; a governed fixture ",
        "is not a live acquisition; payload acquisition is not current source ",
        "qualification; and a missing source is not negative medicines evidence.",
        "",
        "## State counts",
        "",
    ]
